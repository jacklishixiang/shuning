...
$(function()
{
	...
	for(var i=0;i<img01;i++)
	{
		...
		floor1.children[i].innerHTML="<a href='javascript:;'></a><img class='lazy' src='img/floor-bg.gif' data-original='img/jiazhuang/float01/"+(i+1)+".jpg' width='330px'><div class='sales clearfix'><span class='leftspan'><i></i>剩<em>3</em>天</span><span class='rightspan'><em>46</em>人抢购</span></div>";
	}
})
...
$(function()
{
	...
	for(var i=0;i<img;i++)
	{
		...
		producthree.children[i].innerHTML="<div class='item-wrap-t'><a href='#'></a><img class='lazy' src='img/floor-bg.gif' data-original='img/jiazhuang/float03/"+(i+1)+".jpg'><div class='detail'><p class='prd-name'>"+name[i]+"</p><p class='prd-desp-items'><span>27速双碟刹</span><span>三刀轮</span><span>铝合金车架</span><span>山地自行车</span></p></div><div class='sale clearfix'><div class='prd-price clearfix'><div class='sn-price'><i>¥</i><em>"+em[i]+"<b>"+b[i]+"</b></em><del><i>¥</i>"+del[i]+"</del></div></div><div class='discount'><p><span>1</span>件已售</p></div></div>";
	}
})
...
$(function()
{
	...
	for(var i=0;i<img;i++)
	{
		...
		producfour.children[i].innerHTML="<div class='item-wrap-t'><a href='#'></a><img class='lazy' src='img/floor-bg.gif' data-original='img/jiazhuang/float04/"+(i+1)+".jpg'><div class='detail'><p class='prd-name'>"+name[i]+"</p><p class='prd-desp-items'><span>27速双碟刹</span><span>三刀轮</span><span>铝合金车架</span><span>山地自行车</span></p></div><div class='sale clearfix'><div class='prd-price clearfix'><div class='sn-price'><i>¥</i><em>"+em[i]+"<b>"+b[i]+"</b></em><del><i>¥</i>"+del[i]+"</del></div></div><div class='discount'><p><span>1</span>件已售</p></div></div>";
	}
})