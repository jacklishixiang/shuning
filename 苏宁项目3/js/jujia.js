...
$(function()
{
	...
	for(var i=0;i<img01;i++)
	{
		...
		floor1.children[i].innerHTML="<a href='javascript:;'></a><img class='lazy' src='img/floor-bg.gif' data-original='img/jujia/float1/"+(i+1)+".jpg' width='330px'><div class='sales clearfix'><span class='leftspan'><i></i>剩<em>3</em>天</span><span class='rightspan'><em>46</em>人抢购</span></div>";
	}
})
...
$(function()
{
	...
	for(var i=0;i<img;i++)
	{
		...
		producthree.children[i].innerHTML="<div class='item-wrap-t'><a href='#'></a><img class='lazy' src='img/floor-bg.gif' data-original='img/jujia/float3/"+(i+1)+".jpg'><div class='detail'><p class='prd-name'>"+name[i]+"</p><p class='prd-desp-items'><span>27速双碟刹</span><span>三刀轮</span><span>铝合金车架</span><span>山地自行车</span></p></div><div class='sale clearfix'><div class='prd-price clearfix'><div class='sn-price'><i>¥</i><em>"+em[i]+"<b>"+b[i]+"</b></em><del><i>¥</i>"+del[i]+"</del></div></div><div class='discount'><p><span>1</span>件已售</p></div></div>";
	}
})
...
$(function()
{
	...
	for(var i=0;i<img;i++)
	{
		...
		producfour.children[i].innerHTML="<div class='item-wrap-t'><a href='#'></a><img class='lazy' src='img/floor-bg.gif' data-original='img/jujia/float4/"+(i+1)+".jpg'><div class='detail'><p class='prd-name'>"+name[i]+"</p><p class='prd-desp-items'><span>27速双碟刹</span><span>三刀轮</span><span>铝合金车架</span><span>山地自行车</span></p></div><div class='sale clearfix'><div class='prd-price clearfix'><div class='sn-price'><i>¥</i><em>"+em[i]+"<b>"+b[i]+"</b></em><del><i>¥</i>"+del[i]+"</del></div></div><div class='discount'><p><span>1</span>件已售</p></div></div>";
	}
})
...
$(function()
{
	...
	$(".banner-slider li").each(function(i){
		$("<span>"+(i+1)+"</span>").appendTo(".ctrl-squareju");	
	})
	lightju();
	
	function lightju(){
    	$(".ctrl-squareju span").eq(numju).addClass("jucolor").siblings().removeClass("jucolor");
    }
	$(".banner-slider li").eq(numju).css({"opacity":1}).siblings().css({"opacity":0});
	$(".ctrl-squareju span").on("click",function(){
    			     var index=$(this).index();
    			     $(".banner-slider li").eq(index).css({"opacity":0}).animate({"opacity":1},1000);
    			     $(".banner-slider li").eq(numju).animate({"opacity":0},2000);
    			     numju=index;
    			     lightju();
    		});
	
	
	$(".prevju").on("click",function(){
    			
    			$(".banner-slider li").eq(numju).animate({"opacity":0},1000);
    			numju--;
    			numju<0?numju=(($(".banner-slider li").length-1)):numju;
    			$(".banner-slider li").eq(numju).css({"opacity":0}).animate({"opacity":1},1000);
    			lightju();
    		})
	$(".nextju").on("click",autoplay);
	
	
	
	
	$(".arrowju").on("mouseover",function()
	{
		$(".prevju").css("display","block");
		$(".nextju").css("display","block");
	})
	$(".arrowju").on("mouseout",function()
	{
		$(".prevju").css("display","none");
		$(".nextju").css("display","none");
	})
	...
	function autoplay(){
    			$(".banner-slider li").eq(numju).animate({"opacity":0},1000);
    			numju++;
    			numju<$(".banner-slider li").length?numju:numju=0;
    			$(".banner-slider li").eq(numju).css({"opacity":0}).animate({"opacity":1},1000);
    			lightju();
    		}
	...
	$(".ctrl-squareju span").on("mouseover",function(){
    			clearInterval(timer);
    		})
	$(".prevju").on("click",function(){
    			clearInterval(timer);
    		})
	$(".prevju").on("mouseout",function(){
    			timer=setInterval(autoplay,2000);
    		})
	$(".nextju").on("click",function(){
    			clearInterval(timer);
    		})
	$(".nextju").on("mouseout",function(){
    			timer=setInterval(autoplay,2000);
    		})
	$(".ctrl-squareju span").on("mouseout",function(){
    			timer=setInterval(autoplay,2000);
    		})
})
